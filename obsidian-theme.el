...
(custom-theme-set-faces
  'obsidian 
	...
	'(font-lock-constant-face ((t (:foreground "#A082bd"))))
        '(font-lock-doc-face ((t (:foreground "#678cb1"))))
        '(font-lock-function-name-face ((t (:foreground "#678cb1"))))
        '(font-lock-keyword-face ((t (:bold t :foreground "#93c763"))))
        '(font-lock-preprocessor-face ((t (:foreground "#ff9800"))))
        '(font-lock-reference-face ((t (:bold t :foreground "#e0e2e4"))))
        '(font-lock-string-face ((t (:foreground "#ec7600"))))
        '(font-lock-type-face ((t (:foreground "#e0e2e4"))))
